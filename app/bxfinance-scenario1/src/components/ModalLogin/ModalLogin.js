    ...
    return (
      <div>
        <Modal isOpen={this.state.isOpen} toggle={this.toggle.bind(this)} onClosed={this.onClosed.bind(this)} className="modal-login">
          ...
          <ModalBody>
            <form>
            <img className={'modalHeroLogo'} src={process.env.PUBLIC_URL + "/images/logo.png"} alt="logo" />
            <br/>
                ...
                <TabPane tabId="1">{/* Identifier first */}
                  ...
                  <FormGroup className="form-group-light">
                    ...
                    <TextField
                        ...
                        // label={data.form.fields.username.placeholder}
                        label={'User Id'}
                        variant="filled"
                  ...
                  {this.state.loginMethod !== "iPhone" &&
                    <FormGroup className="form-group-light">
                      ...
                      <TextField
                        ...
                        // label={data.form.fields.username.placeholder}
                        label={data.form.fields.otp.label}
                        variant="filled"
                ...
                <TabPane tabId="4">{/* Recover userName. This is now handled by PF to demo Velocity templates. */}
                  ...
                  <FormGroup className="form-group-light">
                    ...
                    <TextField
                        ...
                        // label={data.form.fields.username.placeholder}
                        label={data.form.fields.email.placeholder}
                        variant="filled"
                  ...
                  <div className="mb-3">
                    <ButtonMaterial
                        ...
                        variant="text">
                         {data.form.buttons.recover_username}
                      </ButtonMaterial>
                  </div>
                </TabPane>
